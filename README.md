...
git clone https://github.com/Fsociety133/TBomb.git
cd TBomb
./TBomb.sh
```
...
**A:** There is no official website/app yet.The only official releases of TBomb are published in [Github](https://github.com/Fsociety133/TBomb) and [PyPi](https://pypi.org/project/tbomb)
##
