...
git clone https://github.com/Fsociety133/TBoomb.git
cd TBomb
./TBomb.sh
```
...
**A:** There is no official website/app yet.The only official releases of TBomb are published in [Github](https://github.com/Fsociety133/TBoomb) and [PyPi](https://pypi.org/project/tbomb)
##
...
For Queries: [Telegram Group](https://t.me/+dJRd20Mjxdw4MDJl)  
